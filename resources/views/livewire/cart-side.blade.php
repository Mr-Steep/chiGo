                                        ...
                                        <div class="product-quantity" data-title="Quantity">
                                            <div class="nm-quantity-wrap qty-show">
                                                ...
                                                <div class="quantity px-3">
                                                    <button wire:click="decrementQuantity({{ $cartProduct->product->id}})">-</button>
                                                    ...
                                                    <button wire:click="incrementQuantity({{ $cartProduct->product->id}})">+</button>
                                                </div>
                                            </div>
                                        </div>
            ...
            <div class="nm-cart-panel-summary">
                ...
                <div class="nm-cart-panel-summary-inner">
                    ...
                    <p class="woocommerce-mini-cart__buttons buttons">
                        ...
                        <a href="{{route('cart.index')}}" class="button checkout wc-forward">Checkout</a>
                    </p>


                    <p class="buttons nm-cart-empty-button">
                        <a href="{{route('catalog.index')}}" id="nm-cart-panel-continue" class="button border">
                            Continue shopping
                        </a>
                    </p>
