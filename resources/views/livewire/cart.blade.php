<div class="nm-widget-panel-inner" style="margin-right: 0px;">
                                        ...
                                        <div class="product-quantity" data-title="Quantity">
                                            <div class="nm-quantity-wrap qty-show">
                                                ...
                                                <div class="quantity px-3">
                                                    <button wire:click="decrementQuantity({{ $cartProduct->id}})">-</button>
                                                    ...
                                                    <button wire:click="incrementQuantity({{ $cartProduct->id}})">+</button>
                                                </div>
                                            </div>
                                        </div>
    ...
    <script>
        document.addEventListener('livewire:load', function () {
            Livewire.hook('quantityUpdatedСard', (value) => {
                // Обновление переменной в вашем JavaScript коде
                console.log('Total Quantity Updated:', value.totalQuantity);
            });
        });
    </script>
</div>
