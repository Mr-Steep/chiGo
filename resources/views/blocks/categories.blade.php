            ...
            <div class="col-xs-12">
                ...
                <div id="nm-shop-categories-wrap">
                    <ul id="nm-shop-categories" class="nm-shop-categories">
                        <li class="current-cat"><a href="https://savoy.nordicmade.com/?cat_center=1">
                                <img src="https://savoy.nordicmade.com/wp-content/uploads/2020/12/category-icon-all.jpg"
                                    width="46" height="46" alt="">All</a></li>
                        @foreach($categories as $category)
                            <li class="cat-item-{{$category->id}}">
                                <span class="nm-shop-categories-divider">⁄</span>
                                <a href="{{route('catalog.index')}}">
                                    <img class="grayscale" src=" {{$category->image2}}" width="46" height="46" alt="">
