...
@php
$breadcrumbs = $product->category->getAllParents();
@endphp
...
<x-app-layout>
    ...
    <form action="{{ route('cart.add', $product) }}" method="post">
        ...
        <div class="hidden">
            ...
            <input type="text" name="product_id" value="{{$product->id}}" required>
                            ...
                            @foreach($breadcrumbs as $breadcrumb)
                                <li>
                                    <div class="flex items-center">
                                        <a href="#" class="mr-2 text-sm font-medium text-gray-900">{{$breadcrumb->name}}</a>
                            ...
                            <form class="mt-10">
                                ...
                                <div class="mt-10">
                                    <div class="flex items-center justify-between">
                                        ...
                                        <a href="#" class="text-sm font-medium text-green-600 hover:text-green-500">Size
                                            guide</a>
                                    </div>
                    ...
                    <svg class="absolute inset-0 h-full w-full stroke-2 text-gray-200" viewBox="0 0 100 100"
                      ...
                      <line x1="0" y1="100" x2="100" y2="0" vector-effect="non-scaling-stroke"/>
                                ...
                                <div class="relative flex items-center max-w-[8rem]">
                                    ...
                                    <input type="text" id="quantity" data-input-counter aria-describedby="helper-text-explanation" class="bg-gray-50 border-x-0 border-gray-300 h-11 text-center text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full py-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            name="quantity"
                                ...
                                <button type="submit"
                                        class="mt-10 flex w-full items-center justify-center rounded-md border border-transparent bg-green-700 px-8 py-3 text-base font-medium text-white hover:bg-green-800 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2">
                                    Add to bag
                                </button>
                            </form>
                        </div>
                                ...
                                <div class="mt-4">
                                    <ul role="list" class="list-disc space-y-2 pl-4 text-sm">
                                        <li class="text-gray-400"><span
                                                class="text-gray-600">Hand cut and sewn locally</span></li>
                                        ...
                                        <li class="text-gray-400"><span
                                                class="text-gray-600">Ultra-soft 100% cotton</span></li>
                                    </ul>
                                </div>
                            </div>
