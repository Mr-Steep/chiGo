    ...
    <div class="splide__track">
        <ul class="splide__list">
            <li class="splide__slide">
                <img class="w-full" src="https://savoy.nordicmade.com/wp-content/uploads/2015/08/slider-pendant-lighting.jpg">
                <div class="nm-banner-content">
                    <div class="nm-banner-content-inner h_left v_center align_left">
                        <div class="nm-banner-text medium" style="max-width:41%;">
                            <div class="nm-banner-text-inner nm-animated fadeIn" data-animate="fadeIn"><h1 class="nm-banner-title !text-gray-300">Contemporary Pendant Lighting</h1><a href="https://savoy.nordicmade.com/product-category/interior/" class="nm-banner-link nm-banner-shop-link type-txt">Interior</a></div>
                        </div>
                    </div>
                </div>
            </li>
            <li class="splide__slide">
                <imgclass=w-full  src="https://savoy.nordicmade.com/wp-content/uploads/2015/08/slider-wall-clock.jpg">
                <div class="nm-banner-content">
                    <div class="nm-banner-content-inner h_left v_center align_left">
                        <div class="nm-banner-text medium" style="max-width:41%;">
                            <div class="nm-banner-text-inner nm-animated fadeIn" data-animate="fadeIn"><h1 class="nm-banner-title">Contemporary Pendant Lighting</h1><a href="https://savoy.nordicmade.com/product-category/interior/" class="nm-banner-link nm-banner-shop-link type-txt">Interior</a></div>
                        </div>
                    </div>
                </div>
            </li>
            <li class="splide__slide">
                <img class="w-full" src="https://savoy.nordicmade.com/wp-content/uploads/2015/08/slider-basket.jpg">
                <div class="nm-banner-content">
                    <div class="nm-banner-content-inner h_left v_center align_left">
                        <div class="nm-banner-text medium" style="max-width:41%;">
                            <div class="nm-banner-text-inner nm-animated fadeIn" data-animate="fadeIn"><h1 class="nm-banner-title">Contemporary Pendant Lighting</h1><a href="https://savoy.nordicmade.com/product-category/interior/" class="nm-banner-link nm-banner-shop-link type-txt">Interior</a></div>
